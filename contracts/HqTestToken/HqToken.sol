...
contract HqToken {
    ...
    function transfer(address to, uint256 amount) public returns(bool) {
        ...
        require(_balances[msg.sender] >= amount, "transfer: your balance is not enough");
    ...
    function transferFrom(address from,address to, uint256 amount) public returns(bool) {
        require(from != address(0), "transferFrom: from can't zero address");
        ...
        require(_balances[from] >= amount, "transfer: from balance is not enough");
    ...
    // 将合约的ERC20代币分给用户
    function giveUserAmount(address to, uint256 amount) public returns(bool){
        require(msg.sender == owner, "giveUserAmount: your can't operation");
        require(to != address(0), "giveUserAmount: transfer to the zero address");
        // 注意这里要用this调用
