...
abstract contract BasicToken is Ownable, ERC20Basic {
    ...
    */
     function transfer (address _to, uint _value) public override(ERC20Basic) virtual  onlyPayloadSize(2 * 32) {
    ...
    */
    function balanceOf(address _owner) public override(ERC20Basic) virtual returns (uint balance) {
